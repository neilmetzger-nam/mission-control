  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4 font-mono text-sm text-zinc-300 space-y-8">
      ...
      <section>
        ...
        <p>You are Claude Code working on AI-R — an AI-powered restaurant operating system replacing Toast/Square for independent restaurants. You are building in ~/Desktop/AIR-Web (Next.js 16, App Router, TypeScript, Tailwind v4, HeroUI v2, Drizzle ORM, Neon Postgres, Clerk auth, Vercel).</p>
      ...
      <section>
        ...
        <ul className="space-y-1 list-none">
          ...
          <li>- Working branch: neil. Never push to main (main is Obie&apos;s production branch).</li>
      ...
      <section>
        ...
        <ul className="space-y-1">
          <li>- Frontend: Next.js 16 App Router, TypeScript, Tailwind v4, HeroUI v2</li>
      ...
      <section>
        ...
        <ul className="space-y-1">
          <li>- restaurantId: a613ecc0-ee55-49de-b65e-8afac429f679 (UUID — multi-tenant)</li>
          <li>- Tax rate: 6.5% (Leesburg VA)</li>
          <li>- 514 menu items, 24 categories</li>
          ...
          <li>- Pi at restaurant: 192.168.1.74:3333 (local) / 100.68.30.87:3333 (Tailscale)</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-1 mt-2">
          ...
          <li>- Design Doc: ~/Desktop/AIR-Web/docs/DESIGN-DOC.md (full codebase inventory)</li>
          <li>- Brand Guide: ~/Desktop/AIR-Web/docs/BRAND-GUIDE.md (positioning + messaging rules)</li>
      ...
      <section>
        ...
        <ul className="space-y-1">
          ...
          <li>2. Commit to neil branch with a clear message</li>
